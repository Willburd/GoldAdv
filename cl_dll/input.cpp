...
void InitInput()
{
	...
	// goldadv edit begin - Tweaked movement speeds
	cl_upspeed = gEngfuncs.pfnRegisterVariable("cl_upspeed", "100", 0);
	cl_forwardspeed = gEngfuncs.pfnRegisterVariable("cl_forwardspeed", "100", FCVAR_ARCHIVE);
	cl_backspeed = gEngfuncs.pfnRegisterVariable("cl_backspeed", "100", FCVAR_ARCHIVE);
	cl_sidespeed = gEngfuncs.pfnRegisterVariable("cl_sidespeed", "100", 0);
	// goldadv edit end
